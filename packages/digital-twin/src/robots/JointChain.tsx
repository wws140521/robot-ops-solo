// 关节链原语组件
// 遵循"group 枢轴 + mesh 偏移"的关节层级：
//   JointPivot (group 在关节原点)
//     ├── 关节球 mesh
//     ├── 连杆 mesh (沿 -Y 偏移 length/2)
//     └── 下一级关节（嵌套）
// useFrame 里 lerp 驱动 group.rotation，过渡平滑
...
interface JointChainProps {
  ...
  // 旋转轴
  axis?: 'x' | 'y' | 'z'
  // lerp 平滑速度，越大越快，0 就是不插值
  speed?: number
  children?: React.ReactNode
}

// 单个关节枢轴 group：ref 挂在 group 上，useFrame 里 lerp 旋转到 targetAngle
